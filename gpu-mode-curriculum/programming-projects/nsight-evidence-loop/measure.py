...
def main() -> int:
    ...
    artifact = {
        "project": "nsight-evidence-loop",
        "track": "Profiler-to-roofline evidence",
        "profile": "profiling-roofline",
        ...
        "measurement": {
            ...
            "summary": f"Starter {status} for Profiler-to-roofline evidence; return code {proc.returncode}.",
        },
        "source": "classify_counters.py",
        "environment": "local",
        "baseline_measurement": {"path": "22-gpumode-nsight-roofline/out_gpumode_nsight_roofline.json", "summary": "Imported 2 Nsight-shaped kernel rows and classified them with the same roofline decision rules. Imported bottleneck counts: {'memory-bandwidth': 1, 'compute': 1}."},
        "starter": {
