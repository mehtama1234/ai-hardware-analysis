...
def main() -> int:
    ...
    artifact = {
        "project": "rocm-hip-port",
        "track": "ROCm/HIP portability",
        "profile": "rocm-hip-portability",
        ...
        "measurement": {
            ...
            "summary": f"Starter {status} for ROCm/HIP portability; return code {proc.returncode}.",
        },
        "source": "kernel.hip.cpp",
        "environment": "local",
        "baseline_measurement": {"path": "25-gpumode-rocm-hip-portability/out_gpumode_rocm_hip_portability.json", "summary": "Plain CUDA runtime calls and launch-shape kernels mostly translate mechanically to HIP, but WMMA/Tensor Core source is a real portability boundary that needs rocWMMA/Composable Kernel or a CUTLASS-equivalent rewrite."},
        "starter": {
