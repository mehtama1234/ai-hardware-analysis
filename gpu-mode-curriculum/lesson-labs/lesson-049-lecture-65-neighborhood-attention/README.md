# Lesson Lab 49: Lecture 65: Neighborhood Attention

Source video: https://www.youtube.com/watch?v=y5r2asbfNcs
...
- Concepts: `memory coalescing, shared memory tiling, online softmax, kv cache, kernel fusion, autotuning, compiler lowering`
