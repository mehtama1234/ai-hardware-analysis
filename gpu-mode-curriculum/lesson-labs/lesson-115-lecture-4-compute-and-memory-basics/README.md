# Lesson Lab 115: Lecture 4 Compute and Memory Basics

Source video: https://www.youtube.com/watch?v=lTmYrKwjSOU
...
- Existing programming projects that directly anchor this lesson: `cuda-memory-kernel, rocm-hip-port, jax-scaling-roofline, nsight-evidence-loop`

## Lesson Signals

- Topics: `cuda, attention, hardware, distributed, cutlass`
- Concepts: `memory coalescing, shared memory tiling, warp execution, occupancy, tensor cores, kv cache, compiler lowering, profiling workflow`
- Tools: `CUDA, Triton, PyTorch, torch.compile, CUTLASS/CuTe`
