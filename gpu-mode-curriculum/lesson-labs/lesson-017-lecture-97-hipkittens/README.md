# Lesson Lab 17: Lecture 97: HipKittens

Source video: https://www.youtube.com/watch?v=jsYyF03Fs3o
...
- Existing programming projects that directly anchor this lesson: `cuda-memory-kernel, rocm-hip-port, vllm-kv-scheduler, jax-scaling-roofline, nsight-evidence-loop`

## Lesson Signals

- Topics: `cuda, triton, attention, serving, hardware, cutlass`
- Concepts: `memory coalescing, shared memory tiling, warp execution, occupancy, tensor cores, online softmax, kv cache, compiler lowering, profiling workflow`
- Tools: `CUDA, Triton, PyTorch, CUTLASS/CuTe, ROCm/HIP, TVM`
