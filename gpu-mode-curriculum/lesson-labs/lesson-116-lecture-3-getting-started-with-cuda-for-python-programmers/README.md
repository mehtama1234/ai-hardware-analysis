# Lesson Lab 116: Lecture 3: Getting Started With CUDA for Python Programmers

Source video: https://www.youtube.com/watch?v=4sgKnKbR-WE
...
- Concepts: `memory coalescing, shared memory tiling`
- Tools: `CUDA, PyTorch, CUTLASS/CuTe`
