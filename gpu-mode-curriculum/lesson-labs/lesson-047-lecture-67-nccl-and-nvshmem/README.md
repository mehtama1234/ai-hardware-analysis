# Lesson Lab 47: Lecture 67: NCCL and NVSHMEM

Source video: https://www.youtube.com/watch?v=zxGVvMN6WaM
...
- Topics: `cuda, profiling, serving, hardware, distributed`
- Concepts: `memory coalescing, shared memory tiling, warp execution, tensor cores, kernel fusion, collectives`
- Tools: `CUDA, PyTorch, NCCL, NVSHMEM, ROCm/HIP`
