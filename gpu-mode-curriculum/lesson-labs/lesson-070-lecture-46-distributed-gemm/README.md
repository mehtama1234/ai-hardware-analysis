# Lesson Lab 70: Lecture 46: Distributed GEMM

Source video: https://www.youtube.com/watch?v=NHRTCQBZokg
...
- Existing programming projects that directly anchor this lesson: `rocm-hip-port, distributed-collectives`

## Lesson Signals

- Topics: `cuda, attention, hardware, distributed, cutlass`
- Concepts: `memory coalescing, shared memory tiling, tensor cores, online softmax, kernel fusion, autotuning, collectives, compiler lowering, profiling workflow`
- Tools: `PyTorch, CUTLASS/CuTe, TVM`
