# Lesson Lab 88: GPU MODE IRL 2024 Keynotes

Source video: https://www.youtube.com/watch?v=FH5wiwOyPX4
...
- Existing programming projects that directly anchor this lesson: `vllm-kv-scheduler, hf-quant-serving`

## Lesson Signals

- Topics: `cuda, profiling, attention, quantization, serving, hardware, cutlass`
- Concepts: `warp execution, tensor cores, online softmax, kv cache, kernel fusion, quantized numerics, profiling workflow`
- Tools: `CUDA, Triton, PyTorch, torch.compile, CUTLASS/CuTe, Nsight, ROCm/HIP`
