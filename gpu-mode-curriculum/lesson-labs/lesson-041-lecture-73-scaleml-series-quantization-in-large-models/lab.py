#!/usr/bin/env python3
"""Lesson-specific local proxy program for GPUMODE lesson 41."""
...
LESSON = {
  "index": 41,
  "title": "Lecture 73: [ScaleML Series] Quantization in Large Models",
  "topics": [
    "cuda",
    "quantization",
    "serving",
  ...
  "exercise_candidates": [
    ...
    "measure int8/int4/fp8-style quantization error and memory savings",
