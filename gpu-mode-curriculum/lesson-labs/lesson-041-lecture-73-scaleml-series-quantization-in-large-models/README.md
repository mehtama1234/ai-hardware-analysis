# Lesson Lab 41: Lecture 73: [ScaleML Series] Quantization in Large Models

Source video: https://www.youtube.com/watch?v=6Cxnnvv3DnY
...
- Topics: `cuda, quantization, serving, hardware, distributed`
- Concepts: `warp execution, tensor cores, kv cache, autotuning, quantized numerics, compiler lowering, profiling workflow`
- Tools: `Nsight, TVM`
