# Lesson Lab 6: Lecture 108: One Layer Deeper competition

Source video: https://www.youtube.com/watch?v=ustDJbxOu50
...
- Topics: `cuda, quantization, serving, hardware`
- Concepts: `autotuning, quantized numerics, compiler lowering`
- Tools: `TVM`
