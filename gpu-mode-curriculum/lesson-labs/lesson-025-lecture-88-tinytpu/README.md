# Lesson Lab 25: Lecture 88: TinyTPU

Source video: https://www.youtube.com/watch?v=qCxuLIMycCc
...
- Existing deep lab candidates: `gpumode-lab-02-warp-reductions, gpumode-lab-06-vllm-scheduler, gpumode-lab-08-nsight-to-roofline, gpumode-lab-09-shared-memory-gemm, gpumode-lab-10-tensor-core-cutlass, gpumode-lab-11-rocm-hip-portability, gpumode-lab-12-distributed-communication`
- Existing programming projects that directly anchor this lesson: `none`

## Lesson Signals

- Topics: `serving, hardware`
- Concepts: `shared memory tiling, kernel fusion, compiler lowering`
- Tools: `PyTorch, ROCm/HIP, TVM`
