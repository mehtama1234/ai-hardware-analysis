# Lesson Lab 4: Lecture 110: The 4-bitter lesson: Balancing Stability and Performance in NVFP4 RL

Source video: https://www.youtube.com/watch?v=wiaUh82NEoE
...
- Topics: `cuda, quantization, serving, hardware, distributed, cutlass`
- Concepts: `warp execution, occupancy, tensor cores, autotuning, quantized numerics, compiler lowering, profiling workflow`
- Tools: `Nsight, TVM`
