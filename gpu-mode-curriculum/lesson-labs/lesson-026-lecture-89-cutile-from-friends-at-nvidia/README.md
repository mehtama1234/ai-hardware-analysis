# Lesson Lab 26: Lecture 89: cuTile (from friends at NVIDIA)

Source video: https://www.youtube.com/watch?v=_b4I4rKpsGA
...
- Topics: `cuda, triton, profiling, attention, hardware, cutlass`
- Concepts: `memory coalescing, shared memory tiling, warp execution, tensor cores, online softmax, autotuning, compiler lowering, profiling workflow`
- Tools: `CUDA, Triton, PyTorch, CUTLASS/CuTe, Nsight, TVM`
