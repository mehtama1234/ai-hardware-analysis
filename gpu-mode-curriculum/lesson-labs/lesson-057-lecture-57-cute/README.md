# Lesson Lab 57: Lecture 57: CuTe

Source video: https://www.youtube.com/watch?v=vzUhbDO_0qk
...
- Topics: `cuda, profiling, attention, hardware, distributed, cutlass`
- Concepts: `memory coalescing, shared memory tiling, tensor cores, kernel fusion, autotuning, collectives, profiling workflow`
- Tools: `CUDA, PyTorch, CUTLASS/CuTe, Nsight, ROCm/HIP`
