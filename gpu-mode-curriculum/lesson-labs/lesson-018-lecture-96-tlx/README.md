# Lesson Lab 18: Lecture 96: TLX

Source video: https://www.youtube.com/watch?v=TH1i-GmMZuQ
...
- Topics: `cuda, triton, pytorch-compiler, attention, quantization, hardware, distributed, cutlass`
- Concepts: `memory coalescing, shared memory tiling, warp execution, occupancy, tensor cores, online softmax, kernel fusion, autotuning, quantized numerics, compiler lowering`
- Tools: `Triton, PyTorch, torch.compile, CUTLASS/CuTe, ROCm/HIP`
