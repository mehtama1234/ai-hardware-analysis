# Lesson Lab 100: Lecture 18: Fusing Kernels

Source video: https://www.youtube.com/watch?v=m6BSREnQ84U
...
- Concepts: `tensor cores, kernel fusion, autotuning, compiler lowering, profiling workflow`
- Tools: `CUDA, Triton, PyTorch, TVM`
