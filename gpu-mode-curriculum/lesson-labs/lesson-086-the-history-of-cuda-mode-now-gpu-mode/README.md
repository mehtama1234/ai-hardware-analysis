# Lesson Lab 86: The History of CUDA MODE (Now GPU MODE)

Source video: https://www.youtube.com/watch?v=BmJSIDLoP4s
...
- Concepts: `warp execution, quantized numerics`
- Tools: `CUDA, CUTLASS/CuTe`
