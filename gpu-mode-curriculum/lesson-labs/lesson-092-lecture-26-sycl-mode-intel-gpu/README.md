# Lesson Lab 92: Lecture 26: SYCL Mode (Intel GPU)

Source video: https://www.youtube.com/watch?v=7HqbuMBUV7A
...
- Topics: `cuda, serving, hardware`
- Concepts: `shared memory tiling, tensor cores`
- Tools: `CUDA, ROCm/HIP`
