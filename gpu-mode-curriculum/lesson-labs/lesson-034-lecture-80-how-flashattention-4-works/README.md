# Lesson Lab 34: Lecture 80: How FlashAttention 4 Works

Source video: https://www.youtube.com/watch?v=VPslgC9piIw
...
- Existing programming projects that directly anchor this lesson: `cuda-memory-kernel, jax-scaling-roofline`

## Lesson Signals

- Topics: `cuda, profiling, attention, serving, hardware, cutlass`
- Concepts: `memory coalescing, shared memory tiling, warp execution, tensor cores, online softmax, kv cache, kernel fusion, quantized numerics`
