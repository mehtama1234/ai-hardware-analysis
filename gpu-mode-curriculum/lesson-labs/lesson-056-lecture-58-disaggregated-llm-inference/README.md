# Lesson Lab 56: Lecture 58: Disaggregated LLM Inference

Source video: https://www.youtube.com/watch?v=tIPDwUepXcA
...
- Existing deep lab candidates: `gpumode-lab-01-coalescing, gpumode-lab-03-triton-autotune, gpumode-lab-04-online-softmax, gpumode-lab-05-torch-compile, gpumode-lab-06-vllm-scheduler, gpumode-lab-08-nsight-to-roofline, gpumode-lab-09-shared-memory-gemm, gpumode-lab-12-distributed-communication`
- Existing programming projects that directly anchor this lesson: `none`

## Lesson Signals

- Topics: `pytorch-compiler, profiling, attention, serving`
- Concepts: `kv cache, kernel fusion, autotuning, compiler lowering`
- Tools: `torch.compile, CUTLASS/CuTe`
