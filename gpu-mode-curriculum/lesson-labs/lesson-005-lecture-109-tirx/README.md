# Lesson Lab 5: Lecture 109: TIRx

Source video: https://www.youtube.com/watch?v=nXRsasT1jIk
...
- Topics: `cuda, triton, attention, hardware, distributed, cutlass`
- Concepts: `memory coalescing, shared memory tiling, warp execution, tensor cores, online softmax, kv cache, kernel fusion, autotuning, compiler lowering`
