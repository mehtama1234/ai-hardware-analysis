# Lesson Lab 99: Lecture 19: Data Processing on GPUs

Source video: https://www.youtube.com/watch?v=FUBrIgdIuh0
...
- Concepts: `memory coalescing, autotuning, compiler lowering, profiling workflow`
- Tools: `CUDA, Nsight, TVM`
