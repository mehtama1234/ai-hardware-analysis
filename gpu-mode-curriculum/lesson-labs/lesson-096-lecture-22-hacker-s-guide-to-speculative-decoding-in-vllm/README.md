# Lesson Lab 96: Lecture 22: Hacker's Guide to Speculative Decoding in VLLM

Source video: https://www.youtube.com/watch?v=9wNAgpX6z_4
...
- Concepts: `warp execution, tensor cores, online softmax, kv cache, autotuning, quantized numerics, compiler lowering`
- Tools: `CUDA, PyTorch, vLLM, ROCm/HIP, JAX, TVM`
