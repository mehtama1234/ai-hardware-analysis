# Lesson Lab 90: Lecture 28: Liger Kernel - Efficient Triton Kernels for LLM Training

Source video: https://www.youtube.com/watch?v=gWble4FreV4
...
- Topics: `cuda, triton, profiling, hardware, distributed, cutlass`
- Concepts: `tensor cores, kernel fusion, autotuning, collectives, compiler lowering, profiling workflow`
- Tools: `CUDA, Triton, PyTorch, NCCL, TVM`
