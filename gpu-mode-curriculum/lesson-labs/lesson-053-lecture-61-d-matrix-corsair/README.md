# Lesson Lab 53: Lecture 61: D-Matrix Corsair

Source video: https://www.youtube.com/watch?v=xJ_VYUDAJZw
...
- Topics: `cuda, profiling, attention, quantization, serving, hardware`
- Concepts: `warp execution, tensor cores, kv cache, collectives, quantized numerics, compiler lowering`
- Tools: `PyTorch, CUTLASS/CuTe, ROCm/HIP, TVM`
