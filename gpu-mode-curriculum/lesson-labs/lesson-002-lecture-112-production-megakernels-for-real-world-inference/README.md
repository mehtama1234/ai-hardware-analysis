# Lesson Lab 2: Lecture 112: Production Megakernels for Real-World Inference

Source video: https://www.youtube.com/watch?v=loZ4xQ5RZuU
...
- Topics: `cuda, attention, quantization, serving, hardware, cutlass`
- Concepts: `memory coalescing, shared memory tiling, warp execution, tensor cores, online softmax, kv cache, kernel fusion, autotuning, quantized numerics, compiler lowering, profiling workflow`
- Tools: `CUDA, TVM`
