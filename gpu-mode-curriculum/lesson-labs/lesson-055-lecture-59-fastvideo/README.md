# Lesson Lab 55: Lecture 59: FastVideo

Source video: https://www.youtube.com/watch?v=tquHfKqKo1s
...
- Concepts: `shared memory tiling, tensor cores, online softmax, kv cache, kernel fusion, autotuning, compiler lowering`
- Tools: `PyTorch, TVM`
