# Lesson Lab 114: Lecture 5: Going Further with CUDA for Python Programmers

Source video: https://www.youtube.com/watch?v=wVsR-YhaHlM
...
- Topics: `cuda, hardware, cutlass`
- Concepts: `memory coalescing, shared memory tiling, tensor cores, compiler lowering`
- Tools: `CUDA, PyTorch, ROCm/HIP, TVM`
