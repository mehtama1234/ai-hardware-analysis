# Lesson Lab 62: Bonus Lecture: AMD Developer Challenge

Source video: https://www.youtube.com/watch?v=DOXx3QRZuR8
...
- Topics: `cuda, triton, profiling, hardware`
- Concepts: `memory coalescing, shared memory tiling, tensor cores, kv cache, kernel fusion, autotuning, quantized numerics, compiler lowering`
