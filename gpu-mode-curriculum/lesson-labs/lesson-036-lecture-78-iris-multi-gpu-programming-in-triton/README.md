# Lesson Lab 36: Lecture 78 Iris: Multi-GPU Programming in Triton

Source video: https://www.youtube.com/watch?v=i6Y2EelEC04
...
- Topics: `cuda, triton, hardware, distributed, cutlass`
- Concepts: `memory coalescing, shared memory tiling, tensor cores, kernel fusion, autotuning, collectives, compiler lowering`
- Tools: `Triton, PyTorch, ROCm/HIP, TVM`
