# Lesson Lab 37: Lecture 77: Domain Specific Languages for GPU Kernels

Source video: https://www.youtube.com/watch?v=5qSN-R_E3w0
...
- Topics: `cuda, triton, pytorch-compiler, profiling, attention, hardware, distributed, cutlass`
- Concepts: `warp execution, online softmax, kernel fusion, autotuning, compiler lowering`
