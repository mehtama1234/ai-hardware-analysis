# Lesson Lab 50: Lecture 64: Multi-GPU programming

Source video: https://www.youtube.com/watch?v=BgeFR4UfajQ
...
- Existing deep lab candidates: `gpumode-lab-01-coalescing, gpumode-lab-03-triton-autotune, gpumode-lab-06-vllm-scheduler, gpumode-lab-08-nsight-to-roofline, gpumode-lab-09-shared-memory-gemm, gpumode-lab-11-rocm-hip-portability, gpumode-lab-12-distributed-communication`
- Existing programming projects that directly anchor this lesson: `none`

## Lesson Signals

- Topics: `profiling, distributed`
- Concepts: `memory coalescing, shared memory tiling, collectives, profiling workflow`
- Tools: `CUDA, CUTLASS/CuTe, Nsight, ROCm/HIP`
