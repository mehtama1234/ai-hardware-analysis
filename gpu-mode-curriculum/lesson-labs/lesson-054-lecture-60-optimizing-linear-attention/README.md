# Lesson Lab 54: Lecture 60: Optimizing Linear Attention

Source video: https://www.youtube.com/watch?v=RTJKXK5L8gw
...
- Topics: `cuda, attention, serving, hardware, distributed, cutlass`
- Concepts: `tensor cores, online softmax, kv cache, kernel fusion, autotuning, profiling workflow`
- Tools: `PyTorch`
