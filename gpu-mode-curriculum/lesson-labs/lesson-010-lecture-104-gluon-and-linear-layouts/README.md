# Lesson Lab 10: Lecture 104: Gluon and Linear Layouts

Source video: https://www.youtube.com/watch?v=oYs_qtuk2Pg
...
- Existing programming projects that directly anchor this lesson: `cuda-memory-kernel, jax-scaling-roofline, nsight-evidence-loop`

## Lesson Signals

- Topics: `cuda, triton, profiling, attention, serving, hardware, cutlass`
- Concepts: `memory coalescing, shared memory tiling, warp execution, tensor cores, online softmax, kernel fusion, compiler lowering, profiling workflow`
- Tools: `CUDA, Triton, CUTLASS/CuTe, Nsight, TVM`
