# Lesson Lab 20: Lecture 94: tvm-ffi

Source video: https://www.youtube.com/watch?v=fQcCCSdAFI8
...
- Concepts: `memory coalescing, shared memory tiling, compiler lowering`
- Tools: `CUDA, PyTorch, CUTLASS/CuTe, ROCm/HIP, JAX, TVM`
