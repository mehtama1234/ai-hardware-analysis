# Lesson Lab 85: Lecture 31: Beginners Guide to Metal

Source video: https://www.youtube.com/watch?v=cGtiaJjLkAI
...
- Topics: `cuda, serving, hardware, cutlass`
- Concepts: `memory coalescing, tensor cores, compiler lowering, profiling workflow`
- Tools: `CUDA, PyTorch, CUTLASS/CuTe, ROCm/HIP`
