# Lesson Lab 3: Lecture 111: Spectral Compute: Compile CUDA everywhere

Source video: https://www.youtube.com/watch?v=eujKd0lHegA
...
- Concepts: `shared memory tiling, warp execution, tensor cores, compiler lowering`
- Tools: `CUDA, ROCm/HIP, TVM`
