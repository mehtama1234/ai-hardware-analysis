# Lesson Lab 75: Lecture 41: FlashInfer

Source video: https://www.youtube.com/watch?v=iOLBJwENuvA
...
- Topics: `cuda, attention, serving, hardware, cutlass`
- Concepts: `memory coalescing, shared memory tiling, tensor cores, online softmax, kv cache, autotuning, compiler lowering`
- Tools: `CUDA, PyTorch, ROCm/HIP, JAX, TVM`
