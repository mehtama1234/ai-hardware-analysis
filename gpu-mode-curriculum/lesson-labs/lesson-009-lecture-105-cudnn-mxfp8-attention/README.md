# Lesson Lab 9: Lecture 105: cuDNN mxfp8 attention

Source video: https://www.youtube.com/watch?v=HcnybHRbTcc
...
- Existing programming projects that directly anchor this lesson: `hf-quant-serving`

## Lesson Signals

- Topics: `cuda, profiling, attention, quantization, serving, hardware, distributed, cutlass`
- Concepts: `shared memory tiling, warp execution, tensor cores, online softmax, quantized numerics, compiler lowering`
- Tools: `CUDA, PyTorch, vLLM, JAX, TVM`
