# Lesson Lab 61: GPU MODE @ GTC 2025

Source video: https://www.youtube.com/watch?v=FtgXueoQkA0
...
- Topics: `cuda, profiling, quantization, serving, hardware, cutlass`
- Concepts: `memory coalescing, tensor cores, autotuning, quantized numerics`
