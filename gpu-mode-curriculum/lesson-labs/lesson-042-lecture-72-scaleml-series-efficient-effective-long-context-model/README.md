# Lesson Lab 42: Lecture 72: [ScaleML Series] Efficient & Effective Long-Context Modeling for Large Language Models

Source video: https://www.youtube.com/watch?v=DFcKFDt0QEg
...
- Topics: `profiling, attention, quantization, hardware, cutlass`
- Concepts: `tensor cores, online softmax, kv cache, autotuning, quantized numerics, compiler lowering`
- Tools: `TVM`
