#!/usr/bin/env python3
"""Lesson-specific local proxy program for GPUMODE lesson 42."""
...
LESSON = {
  "index": 42,
  "title": "Lecture 72: [ScaleML Series] Efficient & Effective Long-Context Modeling for Large Language Models",
  "topics": [
    "profiling",
    "attention",
    "quantization",
