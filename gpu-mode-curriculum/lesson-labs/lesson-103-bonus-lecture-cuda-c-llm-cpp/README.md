# Lesson Lab 103: Bonus Lecture: CUDA C++ llm.cpp

Source video: https://www.youtube.com/watch?v=WiB_3Csfj_Q
...
- Topics: `cuda, profiling, cutlass`
- Concepts: `shared memory tiling, warp execution, occupancy, tensor cores, collectives, compiler lowering, profiling workflow`
- Tools: `CUDA, CUTLASS/CuTe, Nsight, ROCm/HIP, TVM`
