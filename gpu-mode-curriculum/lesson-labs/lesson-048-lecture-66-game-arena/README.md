# Lesson Lab 48: Lecture 66: Game Arena

Source video: https://www.youtube.com/watch?v=Yb9MiSInuEs
...
- Concepts: `shared memory tiling, kernel fusion, autotuning, quantized numerics, compiler lowering`
- Tools: `CUTLASS/CuTe, ROCm/HIP, TVM`
