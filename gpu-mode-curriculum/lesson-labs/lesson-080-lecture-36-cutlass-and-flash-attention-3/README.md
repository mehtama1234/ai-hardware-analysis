# Lesson Lab 80: Lecture 36: CUTLASS and Flash Attention 3

Source video: https://www.youtube.com/watch?v=JwUcZwPOCpA
...
- Topics: `cuda, attention, quantization, serving, hardware, distributed, cutlass`
- Concepts: `memory coalescing, shared memory tiling, warp execution, occupancy, tensor cores, online softmax, kernel fusion, autotuning, collectives, quantized numerics, compiler lowering, profiling workflow`
- Tools: `CUTLASS/CuTe, Nsight, ROCm/HIP, TVM`
