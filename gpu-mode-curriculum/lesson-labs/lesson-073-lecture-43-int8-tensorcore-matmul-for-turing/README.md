# Lesson Lab 73: Lecture 43: int8 tensorcore matmul for Turing

Source video: https://www.youtube.com/watch?v=BgGe_erJB1A
...
- Topics: `cuda, profiling, attention, quantization, hardware, distributed, cutlass`
- Concepts: `warp execution, tensor cores, quantized numerics, compiler lowering`
- Tools: `CUDA, TVM`
