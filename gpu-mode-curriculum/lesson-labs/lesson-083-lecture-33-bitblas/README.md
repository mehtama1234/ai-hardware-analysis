# Lesson Lab 83: Lecture 33: Bitblas

Source video: https://www.youtube.com/watch?v=iA49QqWwMcA
...
- Topics: `cuda, triton, profiling, quantization, serving`
- Concepts: `memory coalescing, shared memory tiling, tensor cores, kernel fusion, autotuning, quantized numerics, compiler lowering, profiling workflow`
- Tools: `Triton, Nsight, TVM`
