# Lesson Lab 1: Lecture 113: Every Microsecond Matters: Achieving Near Speed-of-Light Latency in GPU Collectives

Source video: https://www.youtube.com/watch?v=TZnJYRTSGVk
...
- Existing programming projects that directly anchor this lesson: `distributed-collectives`

## Lesson Signals

- Topics: `cuda, profiling, attention, serving, hardware, distributed, cutlass`
- Concepts: `memory coalescing, tensor cores, kv cache, collectives, compiler lowering`
