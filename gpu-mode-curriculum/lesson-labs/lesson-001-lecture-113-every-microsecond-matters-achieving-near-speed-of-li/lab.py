#!/usr/bin/env python3
"""Lesson-specific local proxy program for GPUMODE lesson 1."""
...
LESSON = {
  "index": 1,
  "title": "Lecture 113: Every Microsecond Matters: Achieving Near Speed-of-Light Latency in GPU Collectives",
  "topics": [
    "cuda",
    "profiling",
    "attention",
