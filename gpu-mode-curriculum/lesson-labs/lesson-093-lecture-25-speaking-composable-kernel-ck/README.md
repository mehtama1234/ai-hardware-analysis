# Lesson Lab 93: Lecture 25: Speaking Composable Kernel (CK)

Source video: https://www.youtube.com/watch?v=-732zELVbpU
...
- Topics: `cuda, profiling, attention, hardware, cutlass`
- Concepts: `memory coalescing, shared memory tiling, tensor cores, online softmax, kernel fusion, profiling workflow`
