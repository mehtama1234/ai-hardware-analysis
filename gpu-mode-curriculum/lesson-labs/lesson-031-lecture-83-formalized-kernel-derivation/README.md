# Lesson Lab 31: Lecture 83: Formalized Kernel Derivation

Source video: https://www.youtube.com/watch?v=pB8jRHHGJcE
...
- Topics: `cuda, profiling, attention, quantization, hardware, cutlass`
- Concepts: `tensor cores, online softmax, autotuning, quantized numerics, profiling workflow`
- Tools: `PyTorch, CUTLASS/CuTe, Nsight, ROCm/HIP`
