# Lesson Lab 74: Lecture 42: Mosaic GPU

Source video: https://www.youtube.com/watch?v=wKd90avC8Nc
...
- Topics: `cuda, triton, pytorch-compiler, hardware, cutlass`
- Concepts: `warp execution, tensor cores, kernel fusion, autotuning, compiler lowering, profiling workflow`
- Tools: `CUDA, Triton, PyTorch, torch.compile, CUTLASS/CuTe, Nsight, JAX`
