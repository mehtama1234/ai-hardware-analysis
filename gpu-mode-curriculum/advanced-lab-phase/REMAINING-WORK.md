...
0.00 for the random draft, while preserving parity. CUDA graph capture/replay
is observed for every scenario; the calibrated decode path measured about
0.83x baseline and adaptive fallback about 0.87x. The remaining performance
