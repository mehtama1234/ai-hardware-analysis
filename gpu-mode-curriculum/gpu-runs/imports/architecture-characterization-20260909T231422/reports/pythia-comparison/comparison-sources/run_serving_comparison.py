...
def main():
    ...
    report = {'schema_version':'matched-serving-v0.2','evidence_kind':'measured_gpu',
        ...
        'prompts':PROMPTS,'references':references,'protocol':{'modes':modes,'rates':[16,48],
            ...
            'replay_criterion':'At rate 48, continuous median goodput exceeds both controls; at rate 16, continuous median window completion p95 is below graph groups. Reproduce correctness and these directions, not absolute latency equality.',
