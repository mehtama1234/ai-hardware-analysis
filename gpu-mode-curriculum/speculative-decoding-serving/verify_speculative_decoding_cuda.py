...
def main() -> int:
    ...
    checks = {
        ...
        # The multi-step draft graph is an explicitly rejected experimental
        # candidate for now; accepted reports must prove the target verifier
        # graph, not silently promote the unstable draft-chain capture.
    }
