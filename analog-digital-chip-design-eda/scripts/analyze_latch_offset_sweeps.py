...
def main():
    ...
    for source in args.runs:
        ...
        profiles[-1]["equalizer_release_ns"] = contract.get("equalizer_release_ns")
        profiles[-1]["reset_rise_ps"] = contract.get("reset_rise_ps",20)
        profiles[-1]["reset_fall_ps"] = contract.get("reset_fall_ps",contract["clock_fall_ps"])
