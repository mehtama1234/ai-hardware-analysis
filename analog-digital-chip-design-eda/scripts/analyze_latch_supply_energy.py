...
def main():
    ...
    for path in args.runs:
        ...
        reports.append({"source_run":str(run),"rows":rows,"supply_voltage_v":voltage,
                        "implementation_boundary":c.get("boundary"),"solver":c.get("solver"),
                        "modeled_charge_caps":c.get("modeled_charge_caps",False),
                        ...
                        "strict_waveform_legal":r.get("waveform_legal",r.get("strict_saved_node_envelope_pass")) is True,
