...
* NGSPICE file created from sky130_latch_precharge_wide_input_weak_feedback_flat.ext - technology: sky130A

.subckt sky130_latch_precharge_wide_input_weak_feedback_flat out_p out_n sense_p sense_n
+ tail reset vdd
...
M3 out_n out_p tail VSUBS LATCH_NMOS ad=3 pd=7.4 as=2.76 ps=7 w=1.2 l=1.2
...
C1 sense_p tail 0.19338f
C2 vdd vdd 1.53672f
C3 out_p sense_p 0.05301f
C4 tail out_n 2.11496f
C5 reset out_n 0.05967f
C6 out_p out_n 1.46627f
C7 out_n sense_n 0.06074f
C8 vdd out_n 0.07263f
C9 vdd out_n 0.70572f
C10 out_p tail 2.22358f
C11 out_p reset 0.07615f
C12 tail sense_n 0.19827f
C13 vdd reset 0.20878f
C14 out_p sense_n 0.00703f
C15 vdd out_p 0.28588f
C16 vdd reset 4.03573f
C17 vdd VSUBS 0.90789f
C18 out_n VSUBS 12.38525f
C19 tail VSUBS 25.71941f
C20 vdd VSUBS 30f
.ends
...
XU out_p out_n sense_p sense_n 0 reset vdd sky130_latch_precharge_wide_input_weak_feedback_flat
