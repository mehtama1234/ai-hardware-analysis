...
.include "/home/mehtama1/git-repo/ai-hardware-analysis/analog-digital-chip-design-eda/labs/analog/analog-in-memory-foundation-model-hardware/layout-workbench/extracted/sky130_extracted_isolation_preamp_frontend.spice"
.param vdd=1.8
.param lmin=0.15
.param wp_latch=6
.param wn_latch=3
...
XFRONT vss vdd sp sense_p clk_sample vcm_reset clk_latch sense_n sn sky130_extracted_isolation_preamp_frontend
...
XINP outp sense_n tail 0 sky130_fd_pr__nfet_01v8 W={wn_in} L={lmin}
XINN outn sense_p tail 0 sky130_fd_pr__nfet_01v8 W={wn_in} L={lmin}
