* Sky130 swapped-output transistor active isolation before preamp.
...
RISO_P vdd iso_p 120000
RISO_N vdd iso_n 120000
XISO_P iso_p sense_p iso_tail 0 sky130_fd_pr__nfet_01v8 W=2 L={lmin}
XISO_N iso_n sense_n iso_tail 0 sky130_fd_pr__nfet_01v8 W=2 L={lmin}
IISO_TAIL iso_tail 0 8e-06
CISO_P iso_p 0 2f
CISO_N iso_n 0 2f

RDP vdd pre_p 100000
RDN vdd pre_n 100000
XPREP pre_p iso_n pre_tail 0 sky130_fd_pr__nfet_01v8 W=8 L={lmin}
XPREN pre_n iso_p pre_tail 0 sky130_fd_pr__nfet_01v8 W=8 L={lmin}
