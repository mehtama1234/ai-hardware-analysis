...
RUN_DIR = Path(
    "/home/mehtama1/eda-tools/OpenLane/designs/aimc_scheduler_governor_physical/runs/aimc_scheduler_governor_no_cts_8ns"
)
...
FINAL_ARTIFACTS = [
    "signoff/aimc_scheduler_governor_physical.gds",
    "signoff/aimc_scheduler_governor_physical.lef",
    "signoff/aimc_scheduler_governor_physical.lib",
    "signoff/aimc_scheduler_governor_physical.sdf",
    "signoff/aimc_scheduler_governor_physical.spice",
    "routing/aimc_scheduler_governor_physical.def",
    "routing/aimc_scheduler_governor_physical.nl.v",
]
