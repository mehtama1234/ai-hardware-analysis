...
FINAL_ARTIFACTS = [
    "signoff/aimc_tile_service_scheduler_physical.gds",
    "signoff/aimc_tile_service_scheduler_physical.lef",
    "signoff/aimc_tile_service_scheduler_physical.lib",
    "signoff/aimc_tile_service_scheduler_physical.sdf",
    "signoff/aimc_tile_service_scheduler_physical.spice",
    "routing/aimc_tile_service_scheduler_physical.def",
    "routing/aimc_tile_service_scheduler_physical.nl.v",
]
