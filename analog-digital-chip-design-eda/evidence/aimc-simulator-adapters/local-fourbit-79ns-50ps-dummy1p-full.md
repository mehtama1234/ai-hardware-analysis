...
- status: `transistor_switched_capacitor_dac_incomplete_or_half_lsb_or_legal_range_failed`
- codes measured: `16` of `16`
- half-LSB target V: `5.625000000e-02`
- maximum settling error V: `5.193000000e-02`
- all measured codes within half-LSB: `True`
- all bottom plates in legal range: `False` (`-0.000217 V` to `1.800280 V`)
