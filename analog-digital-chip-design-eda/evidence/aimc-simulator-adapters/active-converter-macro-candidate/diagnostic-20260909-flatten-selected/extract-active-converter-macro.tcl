drc on
path search +/home/mehtama1/git-repo/ai-hardware-analysis/analog-digital-chip-design-eda/evidence/aimc-simulator-adapters/active-converter-macro-candidate/diagnostic-20260909-flatten-selected +/home/mehtama1/git-repo/ai-hardware-analysis/analog-digital-chip-design-eda/labs/analog/analog-in-memory-foundation-model-hardware/layout-workbench/cells
load aimc_converter_macro_active_candidate -force
select top cell
flatten -tree
flatten -tree sky130_transistor_active_isolation_pair
drc check
drc count
extract all
ext2spice lvs
