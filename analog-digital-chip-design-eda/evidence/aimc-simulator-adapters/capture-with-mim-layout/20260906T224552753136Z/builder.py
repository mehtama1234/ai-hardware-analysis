...
def geometry(source,cap):
    ...
    targets=[(1598,36455,"pdiffcont",1000,39000),(2017,36455,"pdiffcont",2500,39000),
             (1626,36083,"ndiffcont",1000,33000),(2050,36083,"ndiffcont",2500,33000)]
    for x,y,contact,cx,cy in targets:
        ...
        wire("metal4",x,y,x,cy)
        wire("metal4",x,cy,cx-146,cy)
