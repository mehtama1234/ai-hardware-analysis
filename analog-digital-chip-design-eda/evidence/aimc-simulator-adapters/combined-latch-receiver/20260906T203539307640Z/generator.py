...
def main():
    ...
    (out/f"{CELL}.mag").write_text(geometry((LATCH/"layout.mag").read_text(),(RECEIVER/"compact_receiver.mag").read_text()))
    ...
    passed=proc.returncode==0 and drc==0 and caps["pass"] and match
