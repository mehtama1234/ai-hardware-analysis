...
def main():
    ...
    deck = replace_line(deck, "VP sense_p ", "VP sense_p 0 " + stimulus(applied_differences, 1))
    deck = replace_line(deck, "VN sense_n ", "VN sense_n 0 " + stimulus(applied_differences, -1))
