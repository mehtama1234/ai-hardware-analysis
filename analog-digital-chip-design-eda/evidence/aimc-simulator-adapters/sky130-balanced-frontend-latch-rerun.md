...
- target combined offset/noise mV: `0.0150`
...
- csv: `labs/analog/analog-in-memory-foundation-model-hardware/measurements/sky130-balanced-frontend-latch-rerun.csv`
...
|---|---:|---:|---:|---:|---|
| `negative_target_edge` | `-0.015000` | `1.624839000` | `0.343601000` | `-1.281240000e+00` | `True` |
| `positive_target_edge` | `0.015000` | `0.343601000` | `1.624839000` | `1.281240000e+00` | `True` |
