...
def run(args):
    ...
    range_requirement={"schema_version":"calibrated_adc_range_requirement.v1",
                       "frozen_plan_sha256":digest(args.quality/"frozen_plan/plan.json"),
    ...
    report={"schema_version":"calibrated_adc_controller_contract.v1",
            ...
            "compiler":{"available_opcodes":OPCODES,"analog_refusal":refusal,
                        ...
                        "missing_operations":["configure ADC range/reference","wait for range settling acknowledgement with matching binding epoch"]},
            "binding_epoch_policy":"increase across waves and vectors; hardware field width, rollover and reset semantics remain undefined",
