...
<header style="padding:64px 0 8px">
  ...
  <p class="dek">Six rungs, six fixes to how a model holds memory. Kimi K3 assembles them — and adds capacity only where it earns its keep. The backbone alternates the constant-state recurrent memory we built (KDA) with periodic full-attention (MLA); on top sit a latent Mixture-of-Experts, a bounded activation, and attention across depth. Each piece has a specific job. <em>That</em> — not the 22,580× — is the story.</p>
  <div class="stat">
