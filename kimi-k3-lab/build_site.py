...
SESSIONS = [
 ...
 (None, None, "Linear attention", "ELU+1 feature map folds K,V into a fixed D×D state — the cache stops growing.", "➗", "soon"),
 (None, None, "DeltaNet", "The delta rule: read-old → subtract → write-new. A finite cache with eviction.", "✏️", "soon"),
 (None, None, "Chunked DeltaNet", "Householder reparameterization → chunk-wise parallel prefill, hardware-efficient training.", "🧩", "soon"),
