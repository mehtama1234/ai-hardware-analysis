...
def main() -> int:
    ...
    sequential_rsi = load("recursive-self-improvement-eda-research/sequential-rsi-rl-benchmark.json")
    sequential_transfer = load("recursive-self-improvement-eda-research/sequential-rsi-transfer-benchmark.json")
    rows = [
        ...
        {"requirement": "learned RSI/RL experiment selection under cost and safety constraints", "status": "passed" if promotion["experiment_policy_promotion"]["status"] == "approved" else "open", "evidence": ["end-to-end-rsi-policy-loop.json", "population-rsi-benchmark.json", "sequential-rsi-rl-benchmark.json", "sequential-rsi-transfer-benchmark.json", "converter-search-predictor-calibration.json", "fresh-adaptive-budget-20260922-1103-1201-1301/adaptive_budget_rsi_experiment.json", "fresh-adaptive-replication-20260922-1409-1501-1601/adaptive_budget_rsi_experiment.json", "fresh-incumbent-challenger-20260922-1709-1801-1901/incumbent_challenger_rsi_experiment.json", "fresh-incumbent-challenger-20260922-2003-2107-2209/incumbent_challenger_rsi_experiment.json", "fresh-polynomial-ridge-incumbent-20260922-2303-2401-2503/incumbent_challenger_rsi_experiment.json", "fresh-recursive-budget-20260922-2603-2701-2803/recursive_budget_rsi_experiment.json", "fresh-conservative-adaptive-20260922-5003-5101-5203/incumbent_challenger_rsi_experiment.json"], "detail": {**loop["learning"], "experiment_policy_promotion": promotion["experiment_policy_promotion"]["status"], "sequential_rsi": sequential_rsi["methods"], "sequential_rsi_adaptive_second_pass": sequential_rsi["recursive_adaptation"]["second_pass"], "sequential_rsi_transfer": sequential_transfer["methods"], "promotion_limitation": "the conservative adaptive policy reduced calls from 288 to 240 but failed per-seed candidate-quality non-regression; retain the baseline selector until a policy passes both gates", "claim_boundary": "The sequential results are offline model-based/tabular RSI over frozen evidence with digital fallback; they are not deep-RL, measured-energy, hardware, or production evidence."}},
