...
def main():
 ...
 records=[
  ...
  {"id":7,"requirement":"heldout_real_designs_test_generalization","status":"blocked","evidence":["real_model","semantic_debugging","historical_breadth","heldout_historical_replay"],"finding":"one upstream held-out historical regression is reconstructed, but real-model closure is 0%/12.5% and held-out semantic localization is unmeasured"},
