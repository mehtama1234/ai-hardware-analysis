...
def main():
 ...
 records=[
  ...
  {"id":7,"requirement":"heldout_real_designs_test_generalization","status":"blocked","evidence":["real_model","semantic_debugging","historical_breadth"],"finding":"real-model held-out closure is 0%/12.5%; held-out semantic localization is unmeasured"},
 ...
 audit={"schema_version":"flagship-definition-of-done-audit-v1","generated_at":datetime.now(timezone.utc).isoformat(),"completion":False,"status":"blocked_pending_requirements","release_decision":"blocked_pending_physical_and_measured_gates","evidence":{k:{"path":rel(v),"sha256":sha(v)} for k,v in evidence.items()},"requirements":records,"blocking_requirements":[4,7],"claim_boundary":"Requirement audit for the declared flagship evidence package; not human approval, held-out generalization, silicon signoff, commercial signoff, or production release."}
