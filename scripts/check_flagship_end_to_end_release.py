    ...
    for item in records:
        ...
        if ROOT not in path.parents or not path.is_file():
            ...
            try:
                ...
                if inventory.get("status") != "ready_for_heldout_execution" or inventory.get("behavioral_contract_count") != 15 or inventory.get("missing_behavioral_contract_count") != 0:
