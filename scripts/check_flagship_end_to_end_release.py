...
REQUIRED = {
    ...
    "real_model_cpu_supplemental_sweep",
}
    ...
    for item in records:
        ...
        if ROOT not in path.parents or not path.is_file():
            ...
            try:
                ...
                if inventory.get("status") != "blocked_pending_behavioral_contracts" or inventory.get("behavioral_contract_count") != 14 or inventory.get("missing_behavioral_contract_count") != 1:
