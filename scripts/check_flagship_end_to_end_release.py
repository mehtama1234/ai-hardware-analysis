    ...
    for item in records:
        ...
        if ROOT not in path.parents or not path.is_file():
            ...
            try:
                ...
                if inventory.get("status") != "blocked_pending_behavioral_contracts" or inventory.get("behavioral_contract_count") != 4 or inventory.get("missing_behavioral_contract_count") != 6:
