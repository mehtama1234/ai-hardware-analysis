...
def main() -> int:
    ...
    for key in ("local_unified_reference", "aggregate_agentic_verification", "proof_carrying_closure", "four_real_causal_agent_repairs", "local_rtl_to_gds_bridge", "structured_register_spec_to_gds"):
