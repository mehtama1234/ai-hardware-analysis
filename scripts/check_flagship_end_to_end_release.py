...
def main() -> int:
    ...
    for key in ("local_unified_reference", "aggregate_agentic_verification", "historical_breadth", "heldout_historical_replay", "proof_carrying_closure", "four_real_causal_agent_repairs", "local_rtl_to_gds_bridge", "structured_register_spec_to_gds", "portable_physical_evidence", "model_to_chip_portable_archive", "real_model_evidence_boundary"):
