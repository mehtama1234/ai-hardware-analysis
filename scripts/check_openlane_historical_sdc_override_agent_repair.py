"""Check the SDC override historical replay report."""
...
def main() -> int:
    ...
    result = {"schema_version": "openlane-historical-sdc-override-agent-repair-check-v1", "status": "passed" if not errors else "blocked", "errors": errors, "report": str(args.report)}
