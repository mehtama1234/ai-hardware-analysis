...
def main() -> int:
    ...
    evidence = {
        ...
        "semantic_debugging_breadth": ROOT / ".artifacts/semantic-debugging-breadth-20260915/receipt.json",
        "heldout_behavioral_contract_inventory": ROOT / ".artifacts/heldout-behavioral-contract-inventory-20260915/inventory.json",
        ...
        "physical_evidence_archive": ROOT / ".artifacts/flagship-physical-evidence-20260915/archive-receipt.json",
        "model_to_chip_manifest": ROOT / "evidence/end-to-end-qualification-manifest.json",
        "model_to_chip_archive_receipt": ROOT / ".artifacts/local-model-to-chip-qualification-20260915/archive-receipt.json",
    ...
    result = {
        ...
        "gates": {
            ...
            "heldout_historical_replay": "passed",
            "heldout_historical_config_replay": "passed",
            ...
            "portable_physical_evidence": "passed",
