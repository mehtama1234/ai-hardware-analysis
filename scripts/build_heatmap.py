...
<div class="hero">
  ...
  <p>1,809 papers · 11 venues · 9 themes. The matrix shows how research focus distributes — and which venues own which problems. Click any cell to see the papers.</p>
</div>
...
<footer>
  Theme assignments by keyword scoring across all 1,809 paper abstracts + full texts. Papers with ambiguous theme are in T0.
