...
const prompt = [
  ...
  `spanning six top venues: MLSys, ISCA, MICRO, HPCA, ASPLOS, DAC (719 papers total, 603 analyzed).`,
  ``,
  `READ these inputs first:`,
  `- ${SDIR}/mlsys-2025-digest.md, isca-2025-digest.md, micro-2025-digest.md, hpca-2025-digest.md,`,
  `  asplos-2025-digest.md, dac-2025-digest.md  — per-venue deterministic roll-ups (normalized`,
  `  hardware_target & workloads counts; RAW technique_category / primary_theme / tags to cluster).`,
  ...
  `  to ground claims in specific papers. IDs look like isca-2025-004, dac-2025-007.`,
  ``,
  ...
  `2. **Per-venue character** — one tight paragraph each (MLSys, ISCA, MICRO, HPCA, ASPLOS, DAC): what that`,
  `   venue is really about, its dominant hardware targets and workloads, and 2-3 signature papers by id.`,
  `   Draw the real contrasts: MLSys is systems-for-LLMs on GPUs; the architecture venues carry the work`,
  `   MLSys lacks — real silicon/ASIC/CIM, memory systems & coherence, interconnect/NoC, security/side-`,
  `   channels, reliability, near-data processing. DAC is the design-automation/EDA venue — compilers,`,
  `   chip generators, verification, and hardware/software co-design tools.`,
  `3. **Shared cross-venue themes** — 6-10 themes that recur ACROSS venues (e.g. LLM/attention accel,`,
  ...
  `4. **What differs by venue** — where the venues diverge (what ISCA/MICRO/HPCA/DAC do that MLSys never`,
  `   touches, and vice versa). This is the core payoff of going wide.`,
  `5. **Cross-cutting observations** — recurring baselines, the co-design reflex, tensions, and honest GAPS.`,
  `6. **Coverage & confidence** — be explicit and honest: 719 papers, 603 analyzed (120 full-text/high,`,
  `   483 abstract-only/low), 116 title-only NOT analyzed (esp. MICRO: 76 title-only because IEEE withholds`,
  `   abstracts; DAC: only 100/457 fetched due to DBLP instability). State that abstract-only analyses are`,
  `   shallower and that MICRO and DAC pictures are under-sampled. Do not overclaim.`,
  ``,
