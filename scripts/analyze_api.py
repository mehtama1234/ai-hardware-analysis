#!/usr/bin/env python3
"""Per-paper Haiku analysis via claude CLI — reads batch files, one paper at a time.

Usage: python3 scripts/analyze_api.py --conf osdi --year 2025
"""
...
def main():
    ...
    print(f"{args.conf} {args.year}: {len(batches)} batch files")
